...
class ImageClassificationIngestModuleFactory(IngestModuleFactoryAdapter):

    # TODO: give it a unique name.  Will be shown in module list, logs, etc.
    moduleName = "Image Classifier"
    ...
    def getModuleDescription(self):
        return "Image classification using CNN"
    ...
    def createDataSourceIngestModule(self, ingestOptions):
        ...
        return ImageClassificationIngestModule()


# Data Source-level ingest module.  One gets created per data source.
# TODO: Rename this to something more specific. Could just remove "Factory" from above name.
class ImageClassificationIngestModule(DataSourceIngestModule):

    _logger = Logger.getLogger(ImageClassificationIngestModuleFactory.moduleName)
    ...
    def startUp(self, context):
        exe_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "model\\testa_exe.exe")
    ...
    def process(self, dataSource, progressBar):
        ...
        for line in lines:           
            ...
            if arquivo:
                ...
                att = BlackboardAttribute(BlackboardAttribute.ATTRIBUTE_TYPE.TSK_SET_NAME, ImageClassificationIngestModuleFactory.moduleName, "Documentos_ID")
